...
2. Set the repository name to **JuanTool** and choose **Private**.
...
Complete the browser sign-in if Git asks. If you create the repository under a different account, replace `Duohewater` in the remote URL.
